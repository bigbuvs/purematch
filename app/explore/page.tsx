...
const DEMO_DOGS: Dog[] = [
  { id: 'd1', owner_id: 'o1', name: 'Arya von Westwood',  breed: 'Border Collie',    age: '2 años', sex: 'Hembra', zone: 'Providencia, RM',  photos: ['https://images.unsplash.com/photo-1503256207526-0d5523f31ed4?w=600&h=800&fit=crop'], pedigree_number: 'KCC-2024-BC-00892', verified: true, score: 95, created_at: '' },
  ...
  { id: 'd5', owner_id: 'o5', name: 'Bella di Milano',     breed: 'Bulldog Inglés',           age: '1 año',  sex: 'Hembra', zone: 'Santiago Centro',  photos: ['https://images.unsplash.com/photo-1561037404-61cd46aa615b?w=600&h=800&fit=crop'], pedigree_number: null,                  verified: true, score: 95, created_at: '' },
